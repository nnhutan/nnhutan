...
const Data = [
  {
    ...
    technologies: "Ruby",
    source: "https://github.com/nnhutan/encrypt_env.git",
    demo: "https://rubygems.org/gems/encrypt_env",
  },
  {
    name: "Debts Manager",
    ...
    time: "July 2022",
    features:
      "Manger your debtors and debts. This app is very helpful for students, people who live together",
    technologies: "Ruby on Rails, Bootstrap, AWS, Caspitrano",
    source: "https://github.com/nnhutan/debt-manager.git",
    demo: "https://debts-manager.herokuapp.com",
  },
  {
    name: "Social crawler",
    ...
    demo: "https://social-post-crawler.herokuapp.com/",
  },
  {
    name: "Web Phone",
    org: "Personal project",
  ...
  },
  {
    ...
    time: "Jan 2022 – Apr 2022",
    features:
      "Measure temp, humid, gas warning, auto turn on and off lights, open and close the door",
    technologies:
      "Figma, IoT devices, Python, React.js, Node.js, Express.js, MongoDB",
  ...
  },
  {
    ...
    features:
      "A product management web about phones, recommending and selling products",
