const ItemEducation = ({ url, university, time, major, courses, gpa }) => {
  return (
    <div className="item-education">
      ...
      <div className="courses ">
        <div className="d-flex flex-column flex-md-row align-items-start ms-md-5">
          <span className="d-flex">
            <i className="bi bi-dot"></i>
            <span className="">GPA:</span>
          </span>
          <span className="detail ms-md-2 ms-3">{gpa}</span>
        </div>
